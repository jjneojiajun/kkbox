...
train = train.rename(columns = {'date':'last_user_log_date'})
test = test.rename(columns = {'date':'last_user_log_date'})
...
# Feature Engineering for user_logs 
...
train.to_csv('sorted_train_v2.csv', encoding='utf-8', index= True)
test.to_csv('sorted_test_v2.csv', encoding='utf-8', index= True)
